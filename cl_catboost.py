...
logging.basicConfig(filename='catboost.log', level=logging.INFO, 
...
logging.info("CatBoost (базовые параметры):")
...
y_pred_tuned = cb_model_tuned.predict(X_test)
...
logging.info("\nCatBoost (настроенные параметры):")
...
cv_scores_tuned = cross_val_score(cb_model_tuned, X, y, cv=5, scoring='f1')
