...
logging.basicConfig(filename='gradientbc.log', level=logging.INFO, 
...
# Базовая модель Gradient Boosting
...
logging.info("Gradient Boosting (базовые параметры):")
...
# Настроенная модель Gradient Boosting
...
logging.info("\nGradient Boosting (настроенные параметры):")
...
cv_scores_tuned = cross_val_score(gb_model_tuned, X, y, cv=5, scoring='f1')
